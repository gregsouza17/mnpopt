...
use EDIT_routines       , only : Eliminate_Fragment , ReGroup , Replicate
...
do
    ...
    write(*,'(/a)') ' (2)  = select frame '      
    write(*,'(/a)') ' (3)  = save PDB trajectory '
    write(*,'(/a)') ' (4)  = re-GROUP molecules ( may need to use AD-HOC )'
    write(*,'(/a)') ' (5)  = DELETE fragment ( uses AD-HOC )'
    write(*,'(/a)') ' (6)  = RMSD of frames'
    write(*,'(/a)') ' (7)  = produce trajectory from single PDB frame'
    write(*,'(/a)') ' (8)  = Interpolate between frames'
    write(*,'(/a)') ' (9)  = Reverse time direction in trajectory'
    write(*,'(/a)') ' (10) = Replicate structure'
    write(*,'(/a)') ' (0)  = DONE                '
    write(*,'(/a)',advance='no') '>>>   '
    read (*,'(I)') choice 
